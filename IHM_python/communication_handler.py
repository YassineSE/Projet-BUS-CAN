...
class CommunicationHandler:
    ...
    def get_orientation_measurements(self):
        ...
        # Receive the CAN message with orientation data
        msg = self.can_interface.receive_message()

        if msg and msg.id == 0x57:  # Verify the message ID is correct
            # Extract orientation data from the received message
            self.phi = (msg.data[0] << 8) | msg.data[1]    # Phi (16 bits)
            self.theta = (msg.data[2] << 8) | msg.data[3]  # Theta (16 bits)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        handler.get_orientation_measurements()
